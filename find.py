...
def find(directory='/Users', file_name=None, case_insensitive=False, extension=None):
    try:
        ...
        print(f"{file_name or 'File'} nu a fost gasit in {directory}")
...
if __name__ == '__main__':
    ...
    # Cazul in care doar extensia este specificata
    if len(sys.argv) == 2 and sys.argv[1].startswith('.'):
        extension = sys.argv[1]

    # Cazul in care doar numele fisierului este specificat
    ...
    # Cazul in care sunt specificate mai multe argumente
    elif len(sys.argv) >= 3:
        directory = sys.argv[1]
